...
const accountListBahByCPR = function (req, res) {
    ...
    // performance.mark('controller-start')
    ...
    service.perform().then((result) => {
        ...
        if (result.error && result.error.type == 'ValidationError') {
            ...
            logger.info({ statusCode: 200, responseController: result }, 'In Conroller Response Account BList Service V2');
            // performance.mark('controller-end')
            // performance.measure('Total Controller Execution time', 'controller-start', 'controller-end')
            // setTimeout(() => {
            //     performance.mark('controller-end')
            //     performance.measure(`Total Controller Execution time `, 'controller-start', 'controller-end')
            //     console.log('Shoaib')
...
module.exports = {
    accountListBahByCPR: accountListBahByCPR
}; 