...
const loggerJs = require('../../../../../common/utils/logger/logger');
const accountDetailsBahService = require('../services/accountDetailsBahService');
const Authenticator = require('../../../../../common/authentication/channelsAuth')

const accountDetailsBah = function (req, res) {
    ...
    let service = new accountDetailsBahService(req.headers, req.params,logger);
...
module.exports = {
    accountDetailsBah: accountDetailsBah
}; 