...
class ClientService {
  ...
  async perform(apiRequest) {
    ...
    const result = await this.client.performRestRequest(apiRequest.headers, apiRequest.body, config.get("api.getStandingOrders.method"), config.get("api.getStandingOrders.url"));
