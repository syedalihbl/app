...
const Res_AccountDetailInquiryModel = require("../../model/Res_GetStandingOrdersModel");
...
class ClientResponse {
  ...
  getPayloadResponse(headers, result) {
    ...
    if (result.RESPONSE && result.RESPONSE.REPCODE === "0000") {
      ...
      return new APIResponse("Fail", {}, new APIError(headers.xReqId, result.RESPONSE.REPCODE, result.RESPONSE.REPMESSAGE, 'TargetSystemError', result))
  }
