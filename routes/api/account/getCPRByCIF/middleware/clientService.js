...
class ClientService {
  ...
  async perform(apiRequest) {
    ...
    const result = await this.client.performRestRequest(apiRequest.headers, apiRequest.body, config.get("api.getCPRByCIF.v1.method"), config.get("api.getCPRByCIF.v1.url"));
