...
const Req_SuplimentaryAccountInfoModel = require('../model/Req_SuplimentaryAccountInfoModel');
const config = require('config');

class getSuplimentaryAccountInfo {
    ...
    constructor(headers, pathParams, queryParams, logger) {
        ...
        this.getSuplimentaryAccountInfoModel = new Req_SuplimentaryAccountInfoModel({ ReqType: queryParams.ReqType, Channel: queryParams.Channel, ReqUID: queryParams.ReqUID, accountNo: pathParams.AccountId })
    ...
    async perform() {
        try {
            ...
            if (headerValidationResponse.error) {
                ...
                const paramValidationResponse = this.getSuplimentaryAccountInfoModel.validateSchema();
                ...
                if (paramValidationResponse.error) {
                    ...
                    const apiRequest = new APIRequest(this.commonHeader, {}, {}, this.getSuplimentaryAccountInfoModel)
                    // console.log(apiRequest)
                    this.logger.debug({ apiRequest: apiRequest }, 'getSuplimentaryAccountInfo API Request')
    
                    const clientService = new ClientService(config.get('api.getSuplimentaryAccountInfo.api_type'), this.logger);
...
module.exports = getSuplimentaryAccountInfo;