const Req_updateConsentPISPModel = require('../model/Req_updateConsentPISPModel');
...
class updateConsentPISPService {
    ...
    constructor(headers, body, logger) {
        ...
        this.updateConsentPISPModel = new Req_updateConsentPISPModel(body);
        this.logger.debug('account statment  Model Object Constructed : ', this.updateConsentPISPModel);
    }
    ...
    async perform() {
        try {
            ...
            const bodyValidationResponse = this.updateConsentPISPModel.validateSchema();
            ...
            const apiRequest = new APIRequest(this.commonHeader, this.updateConsentPISPModel, {}, {});
            this.logger.debug('API Request Object Constructed : ', apiRequest);
            const clientService = new ClientService(config.get('api.updateConsentPISP.v1.api_type'), this.logger);
...
module.exports = updateConsentPISPService;